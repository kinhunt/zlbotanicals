...
- Existing deep-table browser suite: **192 cases passed** (24 science routes × four widths 360/390/768/1440 × JS on/off), validating table counts, scroll regions, citations and no overflow.
- Original-imagery browser suite: **56 page checks passed**, including all 48 product/locale/width cases, plus home/catalog. Screenshots confirm rich product artwork rendering.
