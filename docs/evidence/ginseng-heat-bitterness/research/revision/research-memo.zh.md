...
全文在各温度分别考察反应时间后发现，20(S)-Rg3最高得率随温度升高而降低，Rk1/Rg5各自最高得率则升高；这些峰值并不都出现在相同反应时间，并讨论生成与分解速率竞争；这反对“热越强所有目标皂苷越高”的简化说法，但**没有建立20(S)-Rg3含量与人类苦味评分之间的定量因果**。[4] Methods给140°C时间范围15–135 min，而Results列出10 min点；100°C的Methods为6–72 h，而Results又含3 h；这里只陈述研究尺度和因果边界，不输出可复制工艺参数。
