# Centella cold-process stability: why a better zeta potential can coexist with a changing emulsion
...
| Carrier | Viscosity without ingredient, cP | Viscosity with 10 wt.% ingredient, cP | pH, before → after addition |
|---|---:|---:|---:|
...
Figure 3 shows an initial TSI rise in O/W followed by an approximately level trajectory—not an index that stayed at zero or remained unchanged from day 0. W/O continued to rise, reaching 27.7 at day 84. Gel changed more rapidly after roughly a month and reached 15.7 at day 84. The text describes the gel change as occurring “after 30 days,” whereas neighboring plotted observations are approximately at days 28 and 42. “Changes accelerated after about a month” is more defensible than identifying day 30 as an exact failure date.[1]

The W/O pattern is especially instructive: **increasing zeta-potential magnitude, increasing TSI, and late-emerging coarse-size features occurred together.** The task is not to give two instruments a majority vote over a third. It is to identify what each measurement can reveal under its actual test conditions.

| Measurement | Observation in this study | Useful role in development |
|---|---|---|
...
For the differences between prepared liquids, refined triterpenoid fractions and isolated compounds, see the [Centella ingredient guide](/plant-extracts/ingredients/centella-asiatica). For material selection and sample discussions, visit [Centella asiatica extract](/products/centella-asiatica).
