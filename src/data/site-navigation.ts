...
export function getSiteNavigation(t: ReturnType<typeof useTranslations>, localize: (path: string) => string): NavigationLink[] {
 ...
 return [
  ...
  {...link('nav.applicationsProjects','/solutions'),children:[link('nav.solutions','/solutions'),link('nav.solutionsBeverages','/solutions/beverages'),link('nav.solutionsCosmetics','/solutions/cosmetics'),link('nav.solutionsFood','/solutions/food'),link('nav.solutionsNutraceuticals','/solutions/nutraceuticals'),link('nav.conceptDevelopment','/odm#concept-development'),link('nav.formulaTransfer','/odm#formula-transfer')]},
