...
Resveratrol is a compound, not a species. *Polygonum cuspidatum* identifies the knotweed source described here; confirm the actual source, plant part or alternative production route for each offer.
...
Specify trans-resveratrol separately from cis-resveratrol and total polyphenols. Request the HPLC method, reference standard, reporting basis and carrier declaration.

For knotweed-derived material, discuss emodin and related impurity controls, residual solvents and identity evidence. High assay alone is not a complete impurity profile.

## Application development checks

Evaluate limited aqueous solubility, dispersion, light exposure and the trans/cis profile during storage. Do not infer improved absorption from micronization or encapsulation; assess exact material and use separately.
