...
Leaf extract of *Camellia sinensis*. Tea polyphenols, total catechins, EGCG and caffeine describe different parts of the composition; they are not interchangeable measures of strength.
...
Ask for separate HPLC assays for EGCG, individual catechins and caffeine, alongside the method for total polyphenols. Specify dry-basis or as-is reporting. A colorimetric polyphenol value cannot establish EGCG content.

For a low-caffeine brief, agree a measurable residual caffeine limit and method sensitivity rather than relying on a decaffeinated description. Request extraction-solvent and carrier declarations, leaf traceability and a risk-based pesticide panel.

## Application development checks

For RTD tea, compare clarity, astringency and sediment in the actual water and acid system before and after heat treatment. Track catechin retention, color and haze through storage, including light, oxygen, minerals and packaging variables. High EGCG content does not guarantee a clear-beverage grade.

Have a qualified reviewer assess concentrated-extract use, total caffeine exposure and destination-market restrictions. EGCG assay is not evidence for energy or weight-management claims.
