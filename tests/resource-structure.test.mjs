...
test('every existing bilingual article has one honest guide category and industry metadata without changing legacy metadata', () => {
  for (const lang of ['en', 'zh']) {
    ...
    for (const file of files.filter(file=>!['hibiscus-color-endpoints.md','saffron-identity.md','elderberry-material-selection.md','paprika-extract-format-selection.md','uk-sdil-milk-tea-2028.md','ginseng-heat-bitterness.md','tea-haze-diagnosis.md','stevia-temporal-sensory.md','centella-cold-process-stability.md'].includes(file))) {
